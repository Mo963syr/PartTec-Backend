...
exports.deleteSpicificOrder = async (req, res) => {
  try {
    ...
    if (
      ...
      return res.status(400).json({
        ok: false,
        error: 'cannot_delete_after_30_minutes',
      });
    }
    ...
    await SpicificOrder.findByIdAndDelete(orderId);
    ...
    console.error('deleteSpicificOrder error:', err);
